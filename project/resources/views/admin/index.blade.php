...
<frameset rows="51,*" framespacing="0" border="0">
  ...
  <frameset cols="180, 10, *" framespacing="0" border="0" id="frame-body">
    <frame src="{{ url('admin/menu') }}" id="menu-frame" name="menu-frame" frameborder="no" scrolling="yes">
    <frame src="{{ url('admin/drag') }}" id="drag-frame" name="drag-frame" frameborder="no" scrolling="no">
    <frame src="{{ url('admin/main') }}" id="main-frame" name="main-frame" frameborder="no" scrolling="yes">
  </frameset>
</frameset>
