...
<head>
	...
	<title></title>gif
	<link rel="stylesheet" href="{{ URL::asset('js/transport.js') }}">
	...
	<style type="text/css">
		...
		.explode {background: "{{ URL::asset('images/menu_minus.gif') }}" no-repeat 0px 3px; font-weight: bold;}
		.collapse { background: "{{ URL::asset('images/menu_plus.gif') }}" no-repeat 0px 3px; font-weight: bold;}
		.menu-item { background: "{{ URL::asset('images/menu_arrow.gif') }}" no-repeat 0px 3px; font-weight: normal;}
...
<body>
{{csrf_field()}}
	<div id="tabbar-div"> menu_minus.gif
		<p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg" src="{{ URL::asset('images/menu_minus.gif') }}" width="9" height="9" border="0" alt="闭合"></a>
			</span>
			...
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  ...
						  <li class="menu-item"><a href="{{url('brand/brand_add')}}" target="main-frame">商品品牌</a></li>
...
function toggleCollapse()
{
  ...
  collapse = !collapse;
  document.getElementById('toggleImg').src = collapse ? "{{URL::asset('images/menu_minus.gif')}}" : "{{URL::asset('images/menu_plus.gif')}}";
